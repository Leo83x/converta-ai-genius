        ...
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            <span className="block bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Pare de perder clientes com seu atendimento atual!
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Conecte um <span className="font-semibold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Atendente de IA</span> inteligente ao seu WhatsApp e veja seus leads sendo atendidos, qualificados e convertidos em vendas — sem você precisar digitar uma palavra.
          </p>
